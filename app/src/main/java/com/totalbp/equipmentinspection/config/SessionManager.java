...
import com.totalbp.equipmentinspection.LoginActivity;
...
public class SessionManager {
    ...
    public void createLoginSessionRts(boolean isLoggedIn, String nik){
        // Storing login value as TRUE
        editor.putBoolean(IS_LOGIN, isLoggedIn);
    ...
    public void setUrlConfig(String urlConfig){
        editor.putString(URL_CONFIG,urlConfig);
        editor.commit();
        Log.d(TAG, "User login session modified, config: "+urlConfig);
    }

    public String getUrlConfig(){
        return pref.getString(URL_CONFIG,"");
    }
    ...
    public String getTInspScheID(){
        return pref.getString("TInspScheID","");
    }

    public void setTInspScheID(String tInspScheID){
        editor.putString("TInspScheID",tInspScheID);
        editor.commit();
        Log.d(TAG, "TInspScheID modified, kodeProyek: "+tInspScheID);
    }

    public String getKodeProyek2(){
        return pref.getString("ProyekID2","");
    }

    public void setKodeProyek2(String kodeProyek2){
        editor.putString("ProyekID2",kodeProyek2);
        editor.commit();
        Log.d(TAG, "Kode proyek2 modified, kodeProyek2: "+kodeProyek2);
    }
